/*
    ****NOTES****
    This clas is a module, for use in other scripts.
    Make sure the script element in the HTML contains type="module"
    If you want to be able to roll via buttons, or other HTML elements, use Dice.js.
...
*/
export const Roll = (faces, amount) => {
...
var changeDelay = 200; //0.2 Second
...
/*Rolls dice, and returns the sum.
  ...
  This function also displays each individual roll in a modal.
*/
export const VisualizeRoll = (faces, amount) => {
    if (!validFaces.includes(faces)) {
        console.error("Invalid face count for attempted dice roll. \nGiven Face: " + faces + "\nValid Faces: ", validFaces);
        return -1;
    }
