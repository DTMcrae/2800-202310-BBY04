...
const generateStoryPrompt = () => {
    return `Imagine you are creating a detailed DnD adventure. Please provide the following details:
...
router.post('/generateStory', async (req, res) => {
    try {
        const responseText = await openAI.generateText(generateStoryPrompt(), model, 1200);
